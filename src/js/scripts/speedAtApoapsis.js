...
/**
 * @description Calculates the orbital speed of an object (trivial mass) at apoapsis, orbiting a significantly larger object.
 ...
 * @returns {number} Returns the orbital speed at apoapsis [in m/s].
 */
