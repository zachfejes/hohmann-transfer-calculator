...
function orbitalSpeed(r, m, a) {
  if (r === undefined) {
    throw new Error(
      "r parameter must be defined, but value passed is undefined."
    );
  }
  ...
  if (r < 0) {
    throw new Error(
      "r parameter must be a positive number, but value passed is < 0."
    );
  }
  ...
  if (a !== undefined && a === 0) {
    throw new Error(
      "a parameter must be a non-zero number, but value passed is 0."
    );
  }
